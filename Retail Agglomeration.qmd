...
Furthermore, the theory uses the concept of externalities as disparities in the spatial distubution of activities, thereby laying the territorial bases for dynamic approaches @capello2011.

Regional growth theory involves spatial aspects of economic growth and territorial distribution of income @capello2011.
It also involves generatating geographical advantages, in terms of easy or difficult access of a particular area @capello2011.
...
There are solidly established conclusions regarding the excistanse of agglomeration economies Puga (2010).
...
The bid-rent curve will in this case demonstrate the prise of rent within Bank and Financial locations, Retail locations, and industrial locations.3
...
Furthermore, it influence the central points in diverse ways such as commuter movements, disfuction of knowledge, corporations and network and personal relationship @capello2015.
...
Rogfast might move the population of Haugesund futher south and a new town centre might occur competing with other retail clusters in years to come.
...
A new shopping centre further south in Haugaland or expantion of excisting retail agglomeration areas might be of interest.
...
Spatial data analysis is a rapidly growing area in Statistics @haslett1992. The Journal of the statistics society define such data as being objects in space, which objects have physical location.
